...
VALUES (49, NULL, NULL, '短信配置', 0, NULL, NULL, 0);
INSERT INTO `system_config` (`id`, `key`, `value`, `description`, `pid`, `type`, `option`, `reboot`)
VALUES (50, 'sms_access_key_id', '', '创建短信连接的key', 49, 'text', NULL, 0);
INSERT INTO `system_config` (`id`, `key`, `value`, `description`, `pid`, `type`, `option`, `reboot`)
VALUES (51, 'sms_secret', '', '创建短信连接的密钥', 49, 'password', NULL, 0);
INSERT INTO `system_config` (`id`, `key`, `value`, `description`, `pid`, `type`, `option`, `reboot`)
VALUES (52, 'sms_sign_name', '', '短信签名，在阿里云申请的签名', 49, 'text', NULL, 0);
INSERT INTO `system_config` (`id`, `key`, `value`, `description`, `pid`, `type`, `option`, `reboot`)
VALUES (53, 'sms_template_code', '', '短信模板Code，在阿里云申请的模板Code', 49, 'text', NULL, 0);
