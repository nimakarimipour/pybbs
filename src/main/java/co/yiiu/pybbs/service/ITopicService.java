...
public interface ITopicService {
    ...
    // 分页查询话题
    MyPage<Map<String, @RUntainted Object>> selectAll(@RUntainted Integer pageNo, String tab);
    ...
    // 保存话题
    Topic insert(String title, @RUntainted String content, String tags, User user);
